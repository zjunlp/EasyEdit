...
@dataclass
class ApplyPrismHyperParams(HyperParams):
    # Model related
    alg_name: str = 'prism'
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg_name'] == 'prism') or print(f'ApplyPrismHyperParams can not load from {hparams_name_or_path}, '
