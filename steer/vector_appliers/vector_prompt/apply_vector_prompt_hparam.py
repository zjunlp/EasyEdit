...
@dataclass
class ApplyVectorPromptHyperParams(HyperParams):
    # Model related
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg_name'] == 'vector_prompt') or print(f'ApplyVectorPromptHyperParams can not load from {hparams_name_or_path}, '
