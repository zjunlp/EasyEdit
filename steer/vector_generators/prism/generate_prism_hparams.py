...
@dataclass
class PrismHyperParams(HyperParams):
    # === Basic Config ===
    alg_name: str = 'prism'
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg_name'] == 'prism') or print(f'PrismHyperParams can not load from {hparams_name_or_path}, ' f'alg_name is {config["alg_name"]} ')
