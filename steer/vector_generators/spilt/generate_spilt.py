...
from .generate_spilt_hparams import SpiltHyperParams
from .utils import get_prefix_length, load_state, prepare_groups, save_state
from steer.trainer.SFTTrainer import SFTTrainer


def generate_spilt(args: SpiltHyperParams, dataset, model = None, dataset_name = None):
    """
    ...
    for layer in args.layers:
        ...
        output_dir = os.path.join(
            ...
            f"spilt_{args.intervention_method}"
        )
        ...
        for concept_key, concept_groups in concept_grouped_data:
            ...
            print(f"[INFO] Start to train Spilt for concept: {concept_key_str}")
            ...
            print(f"[INFO] Using concept '{concept}' to train Spilt")
    ...
    print(f"[INFO] Generated Spilt {args.intervention_method} : {all_vectors}")
    if is_multi_concept:
        return all_vectors
    else:
