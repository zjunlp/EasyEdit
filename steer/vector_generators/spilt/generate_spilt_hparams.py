...
@dataclass
class SpiltHyperParams(HyperParams):
    # === Basic Config ===
    alg_name: str = 'spilt'
    ...
    def from_hparams(cls, hparams_name_or_path: str):
        ...
        assert (config and config['alg_name'] == 'spilt') or print(f'SpiltHyperParams can not load from {hparams_name_or_path}, ' f'alg_name is {config["alg_name"]} ')
