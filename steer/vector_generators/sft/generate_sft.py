...
def generate_sft(args: SFTHyperParams, dataset, model = None, dataset_name = None):
    """
    ...
    for layer in args.layers:
        ...
        output_dir = os.path.join(
            ...
            f"sft_{args.intervention_method}"
        )
        ...
        for concept_key, concept_groups in concept_grouped_data:
            ...
            print(f"[INFO] Start to train SFT for concept: {concept_key_str}")
            ...
            print(f"[INFO] Using concept '{concept}' to train SFT")
    ...
    print(f"[INFO] Generated SFT {args.intervention_method} : {all_vectors}")
    if is_multi_concept:
        return all_vectors
    else:
