...
class LlavaOVWrapper(BaseModelWrapper):
    def __init__(
        self,
        torch_dtype=t.float32,
        use_chat: bool = False,
            ...
            if input_seg["type"] == "text":
                ...
                if isinstance(input_seg["content"], str):
                    ...
                    if os.path.exists(abs_path):
                        ...
                        print(f"Warning: Image abspth {abs_path} does not exist.")
    ...
    def multimodal_generate(self, input, **kwargs):
        input_data = self.process_input(input)
        return self.ori_generate(input_data, **kwargs)
