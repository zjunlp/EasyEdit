...
文档目录如下：
---
<!-- TOC -->autoauto- [[CCKS2025——大模型知识编辑评测](https://tianchi.aliyun.com/competition/entrance/532347)](#ccks2025大模型知识编辑评测httpstianchialiyuncomcompetitionentrance532347)auto- [初赛](#初赛)auto    - [1.任务目标](#1任务目标)auto    - [2.数据集介绍](#2数据集介绍)auto    - [3.环境安装](#3环境安装)auto    - [4.快速运行：](#4快速运行)auto        - [基线模型](#基线模型)auto        - [实验设定](#实验设定)auto        - [运行基线](#运行基线)auto        - [FT](#ft)auto        - [ROME](#rome)auto        - [GRACE](#grace)auto        - [LoRA](#lora)auto        - [AlphaEdit](#alphaedit)auto        - [重要说明：](#重要说明)auto    - [5.评测指标](#5评测指标)auto    - [6.文件提交](#6文件提交)auto- [复赛](#复赛)auto    - [1.数据集介绍](#1数据集介绍)auto    - [2.实验设定](#2实验设定)autoauto<!-- /TOC -->
...
python run_CKnowEdit.py \
    --editing_method=FT \
    --hparams_dir=./hparams/FT/qwen2.5-0.5b.yaml \
...
python run_CKnowEdit.py \
    --editing_method=ROME \
    --hparams_dir=./hparams/ROME/qwen2.5-0.5b.yaml \
    --data_dir=./data/CKnowEdit-dataset.json \
    --chinese_ds_type='CKnowEdit' \
    --evaluation_type='generate-text'
```
