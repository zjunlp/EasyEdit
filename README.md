...
- 2024-10-24, EasyEdit has added two new model editing methods, [AlphaEdit](https://github.com/zjunlp/EasyEdit/blob/main/easyeditor/models/alphaedit/README.md) and [DeepEdit](https://arxiv.org/abs/2401.10471). In addition, we have fixed several bugs.
