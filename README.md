...
> ❗️❗️ To be noted, **KnowEdit** is constructed by **re-organizing and cleaning** exsiting datasests including **WikiBio**, **ZsRE**, **WikiData<sub>Counterfact</sub>**,  **WikiData<sub>Recent</sub>**, **convsent**, **Sanitation** 
 with new train/test spliting. Special thanks to the builders and maintainers of the those datasets.
