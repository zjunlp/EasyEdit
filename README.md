...
## 🔔News
- **2024-02-06 We release a preliminary tool [EasyDetect](https://github.com/OpenKG-ORG/EasyDetect) for LLM hallucination detection， with a HF Space [demo](http://easydetect.openkg.cn/)**.
